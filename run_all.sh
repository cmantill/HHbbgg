...
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-700MY60 -y 17 --tag $tag
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-700MY125 -y 17 --tag $tag

python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-1000MY60 -y 17 --tag $tag
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-1000MY125 -y 17 --tag $tag
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-1000MY800 -y 17 --tag $tag
...
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-1400MY60 -y 17 --tag $tag
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-1400MY500 -y 17 --tag $tag
...
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-2000MY60 -y 17 --tag $tag
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-2000MY250 -y 17 --tag $tag
python HHstudies.py -s NMSSM-XToYHTo2g2b-MX-2000MY800 -y 17 --tag $tag
