...
class HHClass:
    ...
    def ApplyKinematicsSnap(self): # For snapshotting only
        ...
        # electrons and muons
        self.a.SubCollection('electrons', "Electron_pt>10 && ((abs(Electron_eta)<1.4442 || abs(Electron_eta)>1.566) && abs(Electron_eta)<2.5) && ")
        self.a.SubCollection('muons', "Muon_pt>10 && abs(Muon_eta)<2.5")
